            ...
            >
                <Box class="calculationModal" sx={style}>
                    ...
                    <div class="modal-container-padding" style={{display: 'block', /*padding: '20px'*/}}>
                        <div style={{display: 'flex', width: '100%', justifyContent: 'center'}}>
                            <div class="modal-content-width" style={{position: 'relative'}}>
                                <div class="text-alignment" style={{width: '100%'}}><h1>Berechnungsgrundlage 1/3</h1></div>
                                <div onClick={handleClose} style={{position: 'absolute', right: '0px', top: '10px', cursor: 'pointer'}}><CloseIcon /></div>
                            </div>
                        ...
                        <div style={{display: 'flex', width: '100%', justifyContent: 'center'}}>
                            <div class="modal-content-width" style={{position: 'relative'}}>
                                <div style={{display: 'flex', flexDirection: 'row', lineHeight: '24px', width: '100%', marginTop: '35px', marginBottom: '30px', fontFamily: 'Bosch-Regular', textAlign: 'left'}}>
                                    <div style={{marginRight: '10px'}}><InfoIcon /></div>
                                    <div>
                            ...
                            <div class="justify-nav" style={{display: 'flex', width: '100%'}}>
                                <div class="modal-nav-width" style={{position: 'relative', marginTop: '30px'}}>
                                    <div style={{display: 'flex', justifyContent: 'space-between'}}>
                                        ...
                                        <div>
                                            <Button id="nextTabBtn" variant="contained" endIcon={<ForwardThinIcon />} onClick={() => { this.nextTab() }} style={{textTransform: 'none', borderRadius: '0px', fontFamily: 'Bosch-Regular'}}>Weiter</Button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-container-padding" style={{display: 'block', /*padding: '20px'*/}}>
                        <div style={{display: 'flex', width: '100%', justifyContent: 'center'}}>
                            <div class="modal-content-width" style={{position: 'relative'}}>
                                <div class="text-alignment" style={{width: '100%'}}><h1>Berechnungsgrundlage 2/3</h1></div>
                                <div onClick={handleClose} style={{position: 'absolute', right: '0px', top: '10px', cursor: 'pointer'}}><CloseIcon /></div>
                            </div>
                        ...
                        <div style={{position: 'fixed', width: '100%', bottom: '2.5%'}}>
                            <div class="justify-nav" style={{display: 'flex', width: '100%'}}>
                                <div class="modal-nav-width" style={{position: 'relative', marginTop: '30px'}}>
                                    <div style={{display: 'flex', justifyContent: 'space-between'}}>
                                        <div>
                                            <Button id="previousTabBtn" variant="outlined" startIcon={<BackThinIcon />} onClick={() => { this.previousTab() }} style={{background: '#FFF', textTransform: 'none', borderRadius: '0px', fontFamily: 'Bosch-Regular'}}>Zurück</Button>
                                        </div>
                                        <div>
                                            <Button id="nextTabBtn" variant="contained" endIcon={<ForwardThinIcon />} onClick={() => { this.nextTab() }} style={{textTransform: 'none', borderRadius: '0px', fontFamily: 'Bosch-Regular'}}>Weiter</Button>
                                        </div>
                    ...
                    <div class="modal-container-padding" style={{display: 'block', /*padding: '20px',*/ overflow: 'hidden'}}>
                        <div style={{display: 'flex', width: '100%', justifyContent: 'center'}}>
                            <div class="modal-content-width" style={{position: 'relative'}}>
                                <div class="text-alignment" style={{width: '100%'}}><h1>Berechnungsgrundlage 3/3</h1></div>
                                <div onClick={handleClose} style={{position: 'absolute', right: '0px', top: '10px', cursor: 'pointer'}}><CloseIcon /></div>
                            </div>
                            ...
                            <div class="justify-nav" style={{display: 'flex', width: '100%'}}>
                                <div class="modal-nav-width" style={{position: 'relative', marginTop: '30px'}}>
                                    <div style={{display: 'flex', justifyContent: 'space-between'}}>
                                        ...
                                        <div>
                                            <Button id="nextTabBtn" variant="contained" onClick={handleClose} style={{textTransform: 'none', borderRadius: '0px', fontFamily: 'Bosch-Regular'}}>Schließen</Button>
                                        </div>
                                    </div>
                                </div>
                            </div>
