    ...
    render() {
      ...
      const { Eta_sh_gas_EDWW_MFH_Brine, setGasBrine, Power_kW_PV_MFH, TCO_thermal_EUR_a, setTCO_thermal_EUR_a, elc_Self_Consumption } = this.context;
          ...
          <div style={{marginLeft: '3%', marginRight: '3%'}}>
            ...
            <div style={{display: 'flex', marginTop: '50px', width: '100%', flexDirection: 'row', justifyContent: 'space-between', alignContent: 'center'}}>
              ...
              <div style={{width: '2px', height: '700px', background: '#E0E2E5', marginLeft: '15px', marginRight: '15px'}}>

              </div>
              <div>
                <div style={{display: 'flex', flexDirection: 'row', fontFamily: 'Bosch-Bold', fontSize: '20px', textAlign: 'left'}}>
