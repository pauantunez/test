...
const pieData = {
  ...
  /*const VictoryPieData = 
    ...
    const VictoryPieData = 
    [
        { x: 3, y: 55, name: "heatpump", label: "3.000 kWh", img: "/img/grid_out.svg", color: "#004975" },
        { x: 1, y: 45, name: "household", label: "1.000 kWh", img: "/img/house_pv.svg", color: "#9E2896" },
    ]

        const VictoryPieDataTest = 
    [
        { x: 3, y: 55, name: "heatpump", label: "55%", img: "/img/grid_out.svg", color: "#004975" },
        { x: 1, y: 45, name: "household", label: "45%", img: "/img/house_pv.svg", color: "#9E2896" },
    ]
