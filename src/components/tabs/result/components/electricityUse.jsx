...
const pieData = {
  ...
  /*const VictoryPieData = 
    ...
    const VictoryPieData = 
    [
        { x: 3, y: 25, name: "heatpump", label: "3.000 kWh", img: "/img/heatpump_small.svg", color: "#004975" },
        { x: 2, y: 25, name: "ev", label: "1.400 kWh", img: "/img/ev_small.svg", color: "#C535BC" },
        { x: 1, y: 50, name: "household", label: "1.000 kWh", img: "/img/household_small.svg", color: "#9E2896" },
    ]

        const VictoryPieDataTest = 
    [
        { x: 3, y: 25, name: "heatpump", label: "25%", img: "/img/heatpump_small.svg", color: "#004975" },
        { x: 2, y: 25, name: "ev", label: "25%", img: "/img/ev_small.svg", color: "#C535BC" },
        { x: 1, y: 50, name: "household", label: "50%", img: "/img/household_small.svg", color: "#9E2896" },
    ]
  ...
  function CustomLabelComponentTest(props) {
    ...
    return (
      ...
      width={imgWidth}
        />
        <text x={xPositionLabel} y={y} class="small" fill={datum.color} font-family="Bosch-Bold" font-size="18">{datum.label}</text>
...
/>
            ...
            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between', marginTop: '0px', fontFamily: 'Bosch-Regular', fontSize: '14px'}}>
