...
class Liability extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.get(`https://policies.ttprivacy.com/api/v1/imprints/legalentity/TTDE/language/${adaptedLangString}`)
        .then(res => {
    ...
    render() {
      ...
      const { overlayToggle } = this.state;
          ...
          <div>
            ...
            <p><strong>Hinweise zu wiedergegebenen Geräuschen</strong></p>

            <p style={{lineHeight: '24px'}}>
            Die simulierte Lautstärke der wiedergegebenen Sounds können von der tatsächlich in der Realität empfundenen Lautstärke abweichen. Die Sounds wurden von handelsüblichen Geräten im Abstand von 1m unter gleichen Bedingungen aufgenommen.
            </p>

            </div>
            <div>
                <Button onClick={() => { this.toggleModal() }} className="btnBackground" style={{position: 'absolute', top: '5px', right: '5px', borderRadius: '40px', width: '40px', height: '40px', color: '#fff', border: 'none', fontFamily: 'Bosch-Bold', background: btnColor}}>x</Button>
            </div>
            ...
            <Button onClick={(e) => { this.toggleModal() }} className="imprintBtn" style={{fontFamily: btnFont}}>
