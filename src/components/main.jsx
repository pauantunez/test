...
breakEvenPVonly =(year) => { 
  const { electricityCost, gridRevenue, electricityCostHouseholdPercentage, pvOutputkWh, homeStorageSize, PVcostLookupTable, StorageCostLookupTable, addHeatpumpPV } = this.context;
  var investmentCostResult
  ...
  const AntTab = styled((props) => <Tab disableRipple {...props} />)(({ theme }) => ({
    ...
    return (
      ...
      { menuOpen &&
          <div style={{position: 'absolute', width: '100%', height: '100%', marginTop: '90px', marginLeft: '10px', background: '#eee', overflowY: 'scroll', zIndex: '999999'}}>
                    <div style={{display: 'flex', flexDirection: 'column', margin: '25px'}}>
                      ...
                      <Link class={steps[0] === false ? 'activeMobileLink': 'inactiveMobileLink'} onClick={() => { this.handleStep(0) }}>
                      ...
                      <Link class={steps[1] === false ? 'activeMobileLink': 'inactiveMobileLink'} onClick={() => { this.handleStep(1) }}>
                      ...
                      <Link class={steps[2] === false ? 'activeMobileLink': 'inactiveMobileLink'} onClick={() => { this.handleStep(2) }}>
                      ...
                      <Link class={steps[3] === false ? 'activeMobileLink': 'inactiveMobileLink'} onClick={() => { this.handleStep(3) }}>
                      ...
                      <Link class={steps[4] === false ? 'activeMobileLink': 'inactiveMobileLink'} onClick={() => { this.handleStep(4) }}>
                      ...
                      <Link class={steps[5] === false ? 'activeMobileLink': 'inactiveMobileLink'} onClick={() => { this.handleStep(5) }}>
                      ...
                      <Link class={steps[6] === false ? 'activeMobileLink': 'inactiveMobileLink'} onClick={() => { this.handleStep(6) }}>
                      ...
                      <Link class={steps[7] === false ? 'activeMobileLink': 'inactiveMobileLink'} onClick={() => { this.handleStep(7) }}>
                      ...
                      <Link class={steps[8] === false ? 'activeMobileLink': 'inactiveMobileLink'} onClick={() => { this.handleStep(8) }}>
                      ...
                      <Link class={steps[9] === false ? 'activeMobileLink': 'inactiveMobileLink'} onClick={() => { this.handleStep(9) }}>
                      ...
                      <Link class={steps[10] === false ? 'activeMobileLink': 'inactiveMobileLink'} onClick={() => { this.handleStep(10) }}>
                      ...
                      <Link class={steps[10] === false ? 'activeMobileLink': 'inactiveMobileLink'} onClick={() => { this.handleStep(11) }}>
                      ...
                      <Link class={steps[10] === false ? 'activeMobileLink': 'inactiveMobileLink'} onClick={() => { this.handleStep(12) }}>
      ...
      >
        <div style={{position: 'absolute', right: '8px', top: '13px'}} onClick={() => {this.handleClick()}}>
          <MenuCloseIcon />
        </div>
      ...
      <div style={{position: 'fixed', width: '100%', bottom: '3%', zIndex: '999999'}}>
        <div style={{display: 'flex', justifyContent: 'space-between', marginLeft: '3%', marginRight: '3%' }}>
          <Button id="previousTabBtn" variant="outlined" startIcon={<BackThinIcon />} disabled={this.state.backBtn} style={{background: '#FFF', textTransform: 'none', borderRadius: '0px', fontFamily: 'Bosch-Regular'}} onClick={() => { previousTab() }}>
          {activeView === 11 &&
            <span>Zurück</span>
          }
          {activeView === 12 &&
