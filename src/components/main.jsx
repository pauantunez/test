        ...
        <div style={{ position: isMobile ? "absolute" : "fixed", width: "100%", bottom: "3%", zIndex: "999999" }}>
          <div style={{ display: "flex", justifyContent: "space-between", marginLeft: "3%", marginRight: "3%" }}>
            ...
            >
              ...
              {activeView === 11 && <span class="trackeable" data-event="result-part1-next">Ergebnis Teil 2</span>}
              ...
              {activeView === 3 && directLink == true && <span class="trackeable" data-event="haushaltsstromverbrauch-back-to-result">Zurück zum Ergebnis</span>}
              ...
              {activeView === 12 && <span class="trackeable" data-event="result-part2-next">Zusatz</span>}
            </CustomButton>
            ...
            >
              <span class="trackeable" data-event="result-part3-back-to-startpage">Zurück zum Start</span>
            </CustomButton> 
          </div>
        </div>
