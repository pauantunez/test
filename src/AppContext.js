...
class SimulatorProvider extends Component {
  ...
  [
    ...
    render() {
      ...
      const { products, btnThemes, fonts, navSteps, product, productSelected, selectedTab, stepperNavActive, entryProduct, activeView, activeStep, activeMilestone, milestoneHeadline, navDirection, time, heatpumpAudio, disableSlider, heatpumpVolume, refernceHeatpumpVolume, viewLocation, viewLocationPrevious, selectedBackgroundAudio, backgroundAudio, deviceIcons, backgroundVolume, appVolume, menuOpen, menuIsFloating, ambientAudio, productList, initialLoad, audioContext, gainNode, mediaSource, backgroundAudioLevels, heatpumpAudioLevels, userTracked, acceptedTerms, Eta_sh_gas_EDWW_MFH_Brine, elc_Self_Consumption, Power_kW_PV_MFH, TCO_thermal_EUR_a, BuildingEnegeryStandard, EnergyUse, BuildingSize, GasOilSwitch, kfwValue, insulationValue, OilLNGValue, disabledOilUsage, OilUsageLiters, LNGUsage, disabledLNGUsage, heatDistributionValue, energyUsagekWh, heatpumpType, ev, pvOutput, odometerIncrease, odometerIncreaseKWH, homeCharging, homeStorage, homeStorageSize, investmentCost, disabledInvestmentCost, investmentCostEUR, electricityCost, gridRevenue, backBtn, fwdBtn, steps, costOverTime, pieChartSize, pieIconSize, innerRadiusMargin, pieLabelFontSize, xPositionHeatpumpLabel, xPositionEVLabel, xPositionHouseholdLabel, yPositionHeatpumpLabel, yPositionEVLabel, yPositionHouseholdLabel, xPositionIconMargin, yPositionIconMargin, xPositionEVIconMargin, yPositionEVIconMargin, xPositionHouseholdIconMargin, yPositionHouseholdIconMargin, anchorEl, backdrop, offgrid1SVG, offgrid2SVG, electricityUse1SVG, electricityUse2SVG, householdUse1SVG, householdUse2SVG, breakEvenBase64, offgridEMS, householdEMS, testSVG, offgrid1SVG_NoEMS_Hidden, offgrid2SVG_NoEMS_Hidden, offgrid1SVG_EMS_Hidden, offgrid2SVG_EMS_Hidden, household1SVG_EMS_Hidden, household2SVG_EMS_Hidden, household1SVG_NoEMS_Hidden, household2SVG_NoEMS_Hidden, calculationModal, activeCalculationView, menuBackdrop, windowWidth, windowHeight, tabEntries, pvMarks, pvOutputkWh, homeStorageSizekWh, tabToSelect, kfwLookupTable, buildingTypePreHeatOption, preHeatTempOption, singlePreHeatOptionNoEVLookupTable, dualPreHeatOptionNoEVLookupTable, singlePreHeatOptionEVLookupTable, dualPreHeatOptionEVLookupTable, scenarioInDatabase,
        EGen_elc_kWh_PV_MFH,
